...
export function LogPanel({ isOpen, onClose, logs, onClear }: LogPanelProps) {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 bg-neutral-900 border-t border-neutral-700 transform transition-transform duration-300 ${
      ...
      {/* Log content */}
      <ScrollArea ref={scrollRef} className="flex-1 p-3 overflow-y-auto">
        <div className="space-y-1 font-mono text-xs" style={{ height: '100%', overflowY: 'auto' }}>
